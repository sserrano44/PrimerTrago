# Django settings for primertrago project.
...
MOBILE_ROOT = os.path.join(PROJECT_DIR, 'mobile')
...
SECRET_KEY = '_tnejh+_9nmam55u=c+65majixqmu@kg98u8h=j9@!0y2-g%s*'
