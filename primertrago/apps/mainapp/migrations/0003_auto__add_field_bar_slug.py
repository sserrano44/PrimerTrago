...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Bar.slug'
        db.add_column('mainapp_bar', 'slug', self.gf('django.db.models.fields.SlugField')(db_index=True, max_length=32, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Bar.slug'
        db.delete_column('mainapp_bar', 'slug')
