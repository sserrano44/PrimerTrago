...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'HappyHour.saturday'
        db.add_column('mainapp_happyhour', 'saturday', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'HappyHour.sunday'
        db.add_column('mainapp_happyhour', 'sunday', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'HappyHour.saturday'
        db.delete_column('mainapp_happyhour', 'saturday')

        # Deleting field 'HappyHour.sunday'
        db.delete_column('mainapp_happyhour', 'sunday')
