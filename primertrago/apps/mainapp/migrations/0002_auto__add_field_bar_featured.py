...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Bar.featured'
        db.add_column('mainapp_bar', 'featured', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Bar.featured'
        db.delete_column('mainapp_bar', 'featured')
